...
This release contains three versions of SGSR2 (3pass, 3passNoAlpha, 2passNoAlpha).
1. Push subfolder "GSR" of any version of SGSR2 into folder "Plugins" of UE5 engine source code(Engine\Plugins\Runtime\Qualcomm), or project plugin folder.
    ...
    Quality Setting:
        r.SGSR2.Quality(refer to GSRTU.cpp): Upscale quality mode. Default is 1(Quality: 1.5x).
            Available:
                ...
                2 - Balanced 			1.7x
                3 - Performance 		2.0x
            For example: device resolution is 2400x1080, r.SGSR2.Quality=1, will upscale from 1600x720 to 2400x1080.
```
...
If storage permissions required, install .apk through Install_[PROJECT]-arm64.bat or enter the following code:
```text
...
The initial upsampling rate is 66.66, which you can set yourself by setting r.SGSR2.Quality or r.ScreenPercentage.

## Build Android for UE5.5 (workable solution)
