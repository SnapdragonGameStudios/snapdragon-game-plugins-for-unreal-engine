...
1. Push subfolder "GSR" of any version of SGSR2 into folder "Plugins" of UE4 engine source code(Engine\Plugins\Runtime\Qualcomm), or project plugin folder.
...
## Build Android for UE4.27 (if Android SDK > 33 special)
